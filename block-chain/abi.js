export const aquaAddress = '0x72B7D61E8fC8cF971960DD9cfA59B8C829D91991'

export const aquaFarmAddress = '0x0ac58Fd25f334975b1B61732CF79564b6200A933'
...
export const aquaStrategyPcsAbi = [
  {
    inputs: [
      ...
      { internalType: 'address[]', name: '_earnedToAQUAPath', type: 'address[]' },
      { internalType: 'address[]', name: '_earnedToToken0Path', type: 'address[]' },
      { internalType: 'address[]', name: '_earnedToToken1Path', type: 'address[]' },
      { internalType: 'address[]', name: '_token0ToEarnedPath', type: 'address[]' },
      { internalType: 'address[]', name: '_token1ToEarnedPath', type: 'address[]' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: '_buyBackAddress', type: 'address' }],
    name: 'SetBuyBackAddress',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: '_govAddress', type: 'address' }],
    name: 'SetGov',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'bool', name: '_onlyGov', type: 'bool' }],
    name: 'SetOnlyGov',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: '_rewardsAddress', type: 'address' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: '_entranceFeeFactor', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: '_withdrawFeeFactor', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: '_controllerFee', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: '_buyBackRate', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: '_slippageFactor', type: 'uint256' },
    ],
    name: 'SetSettings',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: '_uniRouterAddress', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'address payable', name: '_newFeeAddressSetter', type: 'address' }],
  ...
  { inputs: [], name: 'onlyGov', outputs: [{ internalType: 'bool', name: '', type: 'bool' }], stateMutability: 'view', type: 'function' },
  {
    inputs: [],
    name: 'owner',
    outputs: [{ internalType: 'address', name: '', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'address', name: '_buyBackAddress', type: 'address' }],
    name: 'setBuyBackAddress',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'address', name: '_rewardsAddress', type: 'address' }],
    name: 'setRewardsAddress',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'address', name: '_uniRouterAddress', type: 'address' }],
    name: 'setUniRouterAddress',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  { inputs: [], name: 'wrapBNB', outputs: [], stateMutability: 'nonpayable', type: 'function' },
]
...
export const aquaStrategyAquaAbi = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'oldWantLockedTotal', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'newWantLockedTotal', type: 'uint256' },
    ],
    name: 'earned',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'oldMinTimeToWithdraw', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'newMinTimeToWithdraw', type: 'uint256' },
    ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'newMinTimeToWithdraw', type: 'uint256' }],
...
export const autoFarmPCSStrat = [
  {
    inputs: [
      ...
      { internalType: 'address[]', name: '_earnedToAUTOPath', type: 'address[]' },
      { internalType: 'address[]', name: '_earnedToToken0Path', type: 'address[]' },
      { internalType: 'address[]', name: '_earnedToToken1Path', type: 'address[]' },
      { internalType: 'address[]', name: '_token0ToEarnedPath', type: 'address[]' },
      { internalType: 'address[]', name: '_token1ToEarnedPath', type: 'address[]' },
...
export const masterbeltAbi = [
  { inputs: [{ internalType: 'address', name: '_belt', type: 'address' }], stateMutability: 'nonpayable', type: 'constructor' },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'user', type: 'address' },
